    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-600 to-blue-900 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-blue-900 mt-2">DeutschOcean</h1>
          <p className="text-gray-500 text-sm mt-1">Melde dich an und tauche ein!</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Noch kein Konto?{' '}
          <Link href="/registrieren" className="text-blue-600 font-medium hover:underline">
            Registrieren
          </Link>
        </p>
      </div>
