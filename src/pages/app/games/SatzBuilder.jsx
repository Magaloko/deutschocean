    ...
    return (
      <div className={styles.resultPage}>
        <div className={styles.resultEmoji}>
          <Icon emoji={score === TOTAL ? '🏗️' : '⭐'} size={64} color={score === TOTAL ? '#ec4899' : '#fbbf24'} />
        </div>
        ...
        <div className={styles.resultStats}>
          ...
          <Badge color="yellow"><StarsRow count={score === TOTAL ? 3 : score >= Math.ceil(TOTAL * 0.6) ? 2 : 1} /></Badge>
        </div>
    ...
    <div className={`${styles.gamePage} fade-in`}>
      <div className={styles.gameHeader}>
        ...
        <div className={styles.gameInfo}>
          <span className={styles.gameEmoji}><Icon emoji="🏗️" size={24} color="#ec4899" /></span>
